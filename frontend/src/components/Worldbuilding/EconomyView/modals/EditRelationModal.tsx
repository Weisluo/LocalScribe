...
import { EditRelationModalProps } from '../types';
...
export const EditRelationModal = ({
  ...
  useEffect(() => {
    if (relation) {
      ...
      setVolume(relation.volume || '');
      setStartDate(relation.startDate || '');
      setEndDate(relation.endDate || '');
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="编辑经济关系">
