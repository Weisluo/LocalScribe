...
import { AddEraModalProps, EraTheme } from '../types';
import { ERA_THEME_CONFIG } from '../config';

export const AddEraModal = ({ isOpen, onClose, onSubmit, isLoading, error }: AddEraModalProps) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="添加时代">
