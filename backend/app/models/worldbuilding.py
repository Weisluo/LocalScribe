...
class WorldTemplate(Base):
    ...
    modules = relationship(
        "WorldModule", back_populates="template", cascade="all, delete-orphan"
    )
    instances = relationship(
        "WorldInstance", back_populates="template", cascade="all, delete-orphan"
    )
...
class WorldModule(Base):
    ...
    submodules = relationship(
        "WorldSubmodule", back_populates="module", cascade="all, delete-orphan"
    )
    items = relationship(
        "WorldModuleItem", back_populates="module", cascade="all, delete-orphan"
    )
...
class WorldSubmodule(Base):
    ...
    items = relationship(
        "WorldModuleItem", back_populates="submodule", cascade="all, delete-orphan"
    )
